...
# slice the word so we can work with the characters separately.
...
def remove_accents(x):  
    ...
    # Uses regular expression to return the word with numbers, letters and space only.
...
# Creates a super string of exactly 100 characters.
...
# Creates a string of exact 101 characters.
# Cria uma string de exatos 101 caracteres.
...
# Exceeds all checks to be able to release word or not.
